...
module.exports.createAccount = async (req, res) => {
  const { name, dob, gender, panNo, phoneNo, email, address } = req.body;
  try {
    const user = new User({ name, dob, gender, panNo, phoneNo, email, address });
    await user.save();
...
module.exports.updateAccount = async (req, res) => {
  const { name, dob, gender, panNo, phoneNo, email, address, adhaarNo } = req.body;
  const { id } = req.params;
  console.log(id);
  if (!adhaarNo) {
